...
<div class="markdown-nav"><a href="/documentation/registration/admin-home" class="btn btn-outline btn-primary"> Previous</a> <a href="/documentation/registration/getting-started" class="btn btn-outline btn-primary">Main Artice</a> <a href="/documentation/registration/create-event" class="btn btn-outline btn-primary">Next </a></div>
