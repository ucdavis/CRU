...
<ol >
  ...
  <li>Copy or write down your <b>Personal Meeting ID</b> and the meeting URL/link
    <ul >
      <li>If you are unable to change your Personal Meeting ID, you likely need a Zoom Pro license.  Please <a class="external-link" href="/documentation/helpdesk/help-desk-ticket" target="_parent">create a Helpdesk ticket</a> for further assistance.</li>
    </ul>
  </li>
  <li>Click <b>Show</b> to the right of your <b>Host Key</b>
    <ul >
      <li>If you do not have a Host Key, you likely need a Zoom Pro license.  Please <a class="external-link" href="/documentation/helpdesk/help-desk-ticket" target="_parent">create a Helpdesk ticket</a> for further assistance.</li>
    </ul>
  </li>
